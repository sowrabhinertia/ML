...
network.train([
           ...
           {input: { Arsenal: 1, CrystalPalace: 0 }, output: {Arsenal: 1} },
...
//const result = network.run({Newcastle: 0, Swansea: 1 });
const result = brain.likely({WestHam:0.3, Sunderland:0.5}, network);
console.log(result);
